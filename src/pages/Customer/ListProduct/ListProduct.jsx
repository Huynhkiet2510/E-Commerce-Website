                    ...
                    {sortedItems.length > 0 ? sortedItems.map((item) => (
                        ...
                        <div className="col-span-full text-center py-20 bg-card-bg rounded-3xl border-2 border-dashed border-border-customer">
                            <div className="text-gray-400 mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mx-auto text-text-main" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.172 9.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <p className="text-text-main font-medium">Không tìm thấy sản phẩm phù hợp.</p>
                            <button
